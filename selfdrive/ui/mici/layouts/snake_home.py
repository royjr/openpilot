...
class SnakeHomeLayout(MiciHomeLayout):
  def __init__(self):
    super().__init__()
    self._doom_label = UnifiedLabel("snake", font_size=96, font_weight=FontWeight.DISPLAY, text_color=rl.Color(176, 96, 255, 255),
  ...
  def set_callbacks(self, on_settings=None, on_snake=None):
    self._on_settings_click = on_settings
    self._on_doom_click = on_snake
